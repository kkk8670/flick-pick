...
inputFilePath = "/content/movies.csv"
...
distinct_df.coalesce(1).write.option("header", "true").mode("overwrite").csv("/content/csv_movie")

# Show CSV files
import os
print(os.listdir("/content/csv_movie"))
